...
class _OrderItemCardState extends State<OrderItemCard> {
  ...
  Future<void> LoadData() async {
    ...
    for (CartItem item in widget.orderItem.cartItems) {
      productFutures.add(
        FirebaseDBManager.productService.getProductByName(item.productName).then((
          productInfo,
        ) {
        ...
        children: [
          ...
          isStatus
              ...
              : Text(
                  ...
                  style: TextStyle(
                    color: valueColor,
                    fontWeight: isTotal || isBoldValue
                        ? FontWeight.bold
                        : FontWeight.w500,
