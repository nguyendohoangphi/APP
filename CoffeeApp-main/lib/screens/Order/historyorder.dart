...
class _HistoryOrderState extends State<HistoryOrder> {
  ...
  Future<void> LoadData() async {
    ...
    orderItemList = await orderRepo.getOrdersByUser(
    ...
    for (OrderItem orderItem in orderItemList) {
      // Cart items are now populated by OrderItem.fromJson

      // Fetch full product details for images
      for (var item in orderItem.cartItems) {
        try {
          Product product = await productRepo.getProductByName(
            item.productName,
          );
          item.product = product;
        } catch (e) {
          print('Error fetching product for history: $e');
        }
      }
    }
  }
          ...
          return ScrollConfiguration(
            ...
            child: ListView.separated(
              ...
              itemBuilder: (context, index) {
                ...
                String statusText = orderItem.statusOrder
                    .toString()
                    .split('.')
                    .last;
                        ...
                        child: Row(
                          ...
                          children: [
                            Column(
                              ...
                              children: [
                                Text(
                                  orderItem.createDate.split('–')[0].trim(),
                                  style: TextStyle(
                                    fontWeight: FontWeight.bold,
                                    color: textColor,
                                    fontSize: 16,
                                ...
                                Text(
                                  orderItem.createDate.split('–')[1].trim(),
                                  style: TextStyle(
                                    color: widget.isDark
                                        ? AppColors.textSubDark
                                        : AppColors.textSubLight,
