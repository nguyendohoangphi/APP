...
class _CategoryState extends State<Category> {
  ...
  Color get backgroundColor =>
      widget.isDark ? const Color(0xFF1A1D1F) : const Color(0xFFF7F8FA);
  ...
  Widget _buildSearchBar(BuildContext context) {
    return Theme(
      data: widget.isDark ? AppTheme.darkTheme : AppTheme.lightTheme,
      child: SearchAnchor(
          ...
          return Container(
            ...
            child: SearchBar(
              ...
              onSubmitted: (value) {
                ...
                String typeSearch = categoriesSearch.isNotEmpty
                    ? categoriesSearch[0].name
                    : '';
