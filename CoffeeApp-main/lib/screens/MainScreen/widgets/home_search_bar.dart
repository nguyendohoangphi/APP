...
class HomeSearchBar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final Color cardColor = isDark ? AppColors.cardDark : Colors.white;
    ...
    return Padding(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          boxShadow: [isDark ? AppColors.darkShadow : AppColors.softShadow],
        ),
        child: Theme(
          ...
          child: SearchAnchor(
            builder: (BuildContext context, SearchController controller) {
              return SearchBar(
                ...
                hintText: "Tìm món bạn yêu thích...",
                hintStyle: MaterialStateProperty.all(
                  TextStyle(
                    color: isDark
                        ? Colors.grey[500]
                        : AppColors.espressoBrown.withOpacity(0.5),
                    fontSize: 14,
                  ),
                ),
                ...
                leading: Icon(
                  ...
                  color: isDark ? AppColors.warmGold : AppColors.espressoBrown,
                ),
            ...
            suggestionsBuilder: (context, controller) async {
              ...
              final productSearchList = await FirebaseDBManager.productService
