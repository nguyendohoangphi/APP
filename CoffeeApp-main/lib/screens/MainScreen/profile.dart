...
class _ProfileState extends State<Profile> {
  ...
  Widget build(BuildContext context) {
    ...
    if (GlobalData.userDetail.rank.isNotEmpty &&
        ranks.containsKey(GlobalData.userDetail.rank)) {
                            ...
                            child: Container(
                              ...
                              child: CircleAvatar(
                                ...
                                backgroundImage: AssetImage(
                                  GlobalData.userDetail.photoURL.isNotEmpty
                          ...
                          Container(
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                Text(
                                  GlobalData.userDetail.rank.isNotEmpty
